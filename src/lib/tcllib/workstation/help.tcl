...
set HELP(version) "version \n\
                Displays the version information for the Bluespec Workstation."
...
set HELP(help) "help \[-list|-content|-bsv|-about|-command <command_name>\]\n\
