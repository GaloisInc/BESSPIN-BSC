...
proc save_current {} {
        ...
        base::dialog .sc -title "Bluespec Workstation" 
...
proc error_message {text {win ""}} {
        ...
        tk_messageBox -title "Error Bluespec Workstation" -icon error \
...
proc overwrite_project {p} {
        global BSPEC
        base::dialog .s -title "Bluespec Workstation"
...
proc create_help_about_dialog {} {
        ...
        set dat [lindex $v 1]
        set rev [lindex $v 2]
        base::dialog .h -title "About Bluespec Workstation" 
        .h hide Cancel
        .h add_label l1 "Bluespec Workstation" bscMessageFontBold
        set t  "\nBeta version: $rel\nDate: $dat Revision: \
                $rev\n(c) 2007 - 2008 Bluespec Inc.\n All Rights Reserved."
