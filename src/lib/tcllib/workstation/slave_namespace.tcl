# commands and namespace for the Workstation's slave interp
##
    ...
    proc unknown { args } {
        if {[catch {
            ...
            if { [info level] == 1 } {
                ...
                # for background shell jobs indicate that slave interp can take more commands
                if { $isBG } {
