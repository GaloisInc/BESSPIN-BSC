...
itcl::class package_window {
        ...
        proc exportinfo {} {
            ...
            set fn ""
            if { $node != "" } {
                set fn [browsepackage detail $node]
                set fn [lindex $fn 1]
                regsub {::} $fn "__" fn
                regsub {#.*$} $fn "" fn
            }
...
itcl::body package_window::get_items {n} {
        ...
        if {$n == ""} {
                ...
                set rlist [browsepackage list 0]
                set PACKAGE(NODES) ""
                $PACKAGE(INFO) clear
        } else {
                set rlist [browsepackage list $n]
        }
        foreach i $rlist {
