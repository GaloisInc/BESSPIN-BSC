...
### -*- Tcl -*- ##############################################################
###
### (c) Copyright 2008-2009, Bluespec Incorporated. All rights reserved
###
### Time-stamp: <2008-06-19 15:07:29 baltus>
###
### $Id:  $
### $Source:  $
###
...
namespace eval ::FileSupport {
	...
	set src_dir $gBLUESPECDIR/../../src/lib

	set translated [translateFileName $filename $src_dir]
	set translated [file normalize $translated]
