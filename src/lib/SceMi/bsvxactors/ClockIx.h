...
// DO NOT EDIT
// C++ Class with SceMi Message passing for Bluespec type:  PowerContext::ClockIx
...
class ClockIx : public BSVType {
 public:
  ...
  virtual BSVType * getMember (unsigned int idx) {
    switch (idx) {
      case 0: return & m_clockIx;
      default: std::cerr << "Index error in getMember for class ClockIx" << std::endl ;
    };
    return 0;
  };
  ...
  virtual const char * getMemberName (unsigned int idx) const {
    switch (idx) {
      case 0: return "clockIx";
      default: std::cerr << "Index error in getMemberName for class ClockIx" << std::endl ;
    };
    return 0;
  };
