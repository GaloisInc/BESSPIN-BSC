...
#define bit_offset_to_byte_offset(b) ((b) % 8)
#define bit_offset_to_byte_index(b)  ((b) / 8)

#define bit_offset_to_word_offset(b) ((b) % 32)
#define bit_offset_to_word_index(b)  ((b) / 32)
