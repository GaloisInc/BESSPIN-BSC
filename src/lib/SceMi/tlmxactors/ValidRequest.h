...
/// A templated class for checking TLMRequests.
...
public:
  ...
  ///  Checks that the TLMRequest is valid for the specific transactor type.
...
protected:
  ...
  /// Error message when the bus fabric does not support the requests
  /// lock mode.
  ...
  /// burst size.  Note that the transactor break the burst into legal
  /// sizes.
...
private:
  ...
  ///  Check that the burst does not cross the specified boundary.
