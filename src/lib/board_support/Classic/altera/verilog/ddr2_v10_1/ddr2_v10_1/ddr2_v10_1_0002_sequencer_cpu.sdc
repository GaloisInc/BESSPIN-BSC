...
set 	sequencer_cpu 	${::GLOBAL_ddr2_v10_1_0002_corename}_sequencer_cpu:the_sequencer_cpu
set 	sequencer_cpu_oci 	${::GLOBAL_ddr2_v10_1_0002_corename}_sequencer_cpu_nios2_oci:the_sequencer_cpu_nios2_oci
set 	sequencer_cpu_oci_break 	${::GLOBAL_ddr2_v10_1_0002_corename}_sequencer_cpu_nios2_oci_break:the_sequencer_cpu_nios2_oci_break
set 	sequencer_cpu_ocimem 	${::GLOBAL_ddr2_v10_1_0002_corename}_sequencer_cpu_nios2_ocimem:the_sequencer_cpu_nios2_ocimem
set 	sequencer_cpu_oci_debug 	${::GLOBAL_ddr2_v10_1_0002_corename}_sequencer_cpu_nios2_oci_debug:the_sequencer_cpu_nios2_oci_debug
set 	sequencer_cpu_wrapper 	${::GLOBAL_ddr2_v10_1_0002_corename}_sequencer_cpu_jtag_debug_module_wrapper:the_sequencer_cpu_jtag_debug_module_wrapper
set 	sequencer_cpu_jtag_tck 	${::GLOBAL_ddr2_v10_1_0002_corename}_sequencer_cpu_jtag_debug_module_tck:the_sequencer_cpu_jtag_debug_module_tck
set 	sequencer_cpu_jtag_sysclk 	${::GLOBAL_ddr2_v10_1_0002_corename}_sequencer_cpu_jtag_debug_module_sysclk:the_sequencer_cpu_jtag_debug_module_sysclk
