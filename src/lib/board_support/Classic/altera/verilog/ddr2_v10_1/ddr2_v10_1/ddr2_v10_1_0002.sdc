...
#      in the ddr2_v10_1_0002_timing.tcl script.
#    * The helper routines are defined in ddr2_v10_1_0002_pin_map.tcl
#
# NOTE
# ----
...
source "$script_dir/ddr2_v10_1_0002_timing.tcl"
...
if { $::GLOBAL_ddr2_v10_1_0002_phy_use_micro_timing } {
	##################
	#                #
	# QUERIED TIMING #
	#                #
	...
	set io_standard "$::GLOBAL_ddr2_v10_1_0002_io_standard CLASS I"

	# This is the peak-to-peak jitter on the whole read capture path
	set DQSpathjitter [expr [get_io_standard_node_delay -dst DQDQS_JITTER -io_standard $io_standard -parameters [list IO $::GLOBAL_ddr2_v10_1_0002_io_interface_type] -in_fitter]/1000.0]
	set DQSpathjitter_setup_prop [expr [get_io_standard_node_delay -dst DQDQS_JITTER_DIVISION -io_standard $io_standard -parameters [list IO $::GLOBAL_ddr2_v10_1_0002_io_interface_type] -in_fitter]/100.0]

	set tJITper [expr [get_io_standard_node_delay -dst MEM_CK_PERIOD_JITTER -io_standard $io_standard  -parameters [list IO $::GLOBAL_ddr2_v10_1_0002_io_interface_type] -in_fitter -period $t(CK)]/2000.0]
...
if { ! [ info exists ddr2_v10_1_0002_sdc_cache ] } {
	set ddr2_v10_1_0002_sdc_cache 1
	ddr2_v10_1_0002_initialize_ddr_db ddr2_v10_1_0002_ddr_db
} else {
	if { $debug } {
...
# following loop
set instances [ array names ddr2_v10_1_0002_ddr_db ]
foreach { inst } $instances {
	if { [ info exists pins ] } {
		# Clean-up stale content
		unset pins
	}
	array set pins $ddr2_v10_1_0002_ddr_db($inst)
	...
	set fpga(tDQS_PHASE_JITTER) [ expr [ get_integer_node_delay -integer $::GLOBAL_ddr2_v10_1_0002_dqs_delay_chain_length -parameters {IO MAX HIGH} -src DQS_PHASE_JITTER -in_fitter ] / 1000.0 ]

	# Phase Error on DQS paths. This parameter is queried at run time
	set fpga(tDQS_PSERR) [ expr [ get_integer_node_delay -integer $::GLOBAL_ddr2_v10_1_0002_dqs_delay_chain_length -parameters {IO MAX HIGH} -src DQS_PSERR -in_fitter ] / 1000.0 ]
	...
	if { $debug } {
		...
		post_message -type info "SDC: -----------------"
		post_message -type info "SDC:    DQS Phase: $::GLOBAL_ddr2_v10_1_0002_dqs_delay_chain_length"
	...
	# PLL Clock Names
	set local_pll_afi_clk "${inst}|ddr2_v10_1_0002_pll_afi_clk"
	set local_pll_mem_clk "${inst}|ddr2_v10_1_0002_pll_mem_clk"
	set local_pll_write_clk "${inst}|ddr2_v10_1_0002_pll_write_clk"
	set local_pll_addr_cmd_clk "${inst}|ddr2_v10_1_0002_pll_addr_cmd_clk"
	set local_pll_afi_half_clk "${inst}|ddr2_v10_1_0002_pll_afi_half_clk"
	set local_pll_avl_clock "${inst}|ddr2_v10_1_0002_pll_avl_clock"
	set local_pll_config_clock "${inst}|ddr2_v10_1_0002_pll_config_clock"
	...
	# W A R N I N G !
	# The PLL parameters are statically defined in the ddr2_v10_1_0002_parameters.tcl
	...
	# apply those changes to the PLL parameters in the ddr2_v10_1_0002_parameters.tcl

	create_generated_clock -add -name "$local_pll_afi_clk" -source $pll_ref_clock -multiply_by $::GLOBAL_ddr2_v10_1_0002_pll_0_mult -divide_by $::GLOBAL_ddr2_v10_1_0002_pll_0_div -phase $::GLOBAL_ddr2_v10_1_0002_pll_0_phase $pll_afi_clock
if {[string compare -nocase $pll_afi_clock $pll_ck_clock]==0} {
	set local_pll_mem_clk $local_pll_afi_clk
} else {
	create_generated_clock -add -name "$local_pll_mem_clk" -source $pll_ref_clock -multiply_by $::GLOBAL_ddr2_v10_1_0002_pll_1_mult -divide_by $::GLOBAL_ddr2_v10_1_0002_pll_1_div -phase $::GLOBAL_ddr2_v10_1_0002_pll_1_phase $pll_ck_clock
}
	create_generated_clock -add -name "$local_pll_write_clk" -source $pll_ref_clock -multiply_by $::GLOBAL_ddr2_v10_1_0002_pll_2_mult -divide_by $::GLOBAL_ddr2_v10_1_0002_pll_2_div -phase $::GLOBAL_ddr2_v10_1_0002_pll_2_phase $pll_write_clock
	create_generated_clock -add -name "$local_pll_addr_cmd_clk" -source $pll_ref_clock -multiply_by $::GLOBAL_ddr2_v10_1_0002_pll_3_mult -divide_by $::GLOBAL_ddr2_v10_1_0002_pll_3_div -phase $::GLOBAL_ddr2_v10_1_0002_pll_3_phase $pll_ac_clock
	create_generated_clock -add -name "$local_pll_afi_half_clk" -source $pll_ref_clock -multiply_by $::GLOBAL_ddr2_v10_1_0002_pll_4_mult -divide_by $::GLOBAL_ddr2_v10_1_0002_pll_4_div -phase $::GLOBAL_ddr2_v10_1_0002_pll_4_phase $pll_afi_half_clock
	create_generated_clock -add -name "$local_pll_avl_clock" -source $pll_ref_clock -multiply_by $::GLOBAL_ddr2_v10_1_0002_pll_5_mult -divide_by $::GLOBAL_ddr2_v10_1_0002_pll_5_div -phase $::GLOBAL_ddr2_v10_1_0002_pll_5_phase $pll_avl_clock
	create_generated_clock -add -name "$local_pll_config_clock" -source $pll_ref_clock -multiply_by $::GLOBAL_ddr2_v10_1_0002_pll_6_mult -divide_by $::GLOBAL_ddr2_v10_1_0002_pll_6_div -phase $::GLOBAL_ddr2_v10_1_0002_pll_6_phase $pll_config_clock
	...
	create_generated_clock -add -name "${inst}|memphy_leveling_clk" -master_clock [get_clocks $local_pll_write_clk] -source $pll_write_clock -phase $::GLOBAL_ddr2_v10_1_0002_leveling_capture_phase [ get_pins $leveling_pins ]
...
if { $::GLOBAL_ddr2_v10_1_0002_phy_use_micro_timing } {
	if {(($::quartus(nameofexecutable) ne "quartus_fit") && ($::quartus(nameofexecutable) ne "quartus_map"))} {
		set dqs_clocks [ddr2_v10_1_0002_get_all_instances_dqs_pins ddr2_v10_1_0002_ddr_db]
...
add_ddr_report_command "source [list [file join [file dirname [info script]] ${::GLOBAL_ddr2_v10_1_0002_corename}_report_timing.tcl]]"
