...
You must run the ddr2_v10_1_pin_assignments.tcl script after Quartus II Analysis and Synthesis has completed
...
Ex 1: Running ddr2_v10_1_pin_assignments.tcl from the GUI
   * On the Tools menu, select Tcl Scripts
   * Select ddr2_v10_1_pin_assignments.tcl
   * Click Run

Ex 2: Running ddr2_v10_1_pin_assignments.tcl from a shell
   * Type quartus_sh -t <uniphy_ip_output_path>/ddr2_v10_1_pin_assignments.tcl <project_name>
...
The <uniphy_ip_output_path>/ddr2_v10_1_memphy_top.v contains just the PHY portion with the parameter defaults
