...
#      in the ddr2_v12_1_p0_timing.tcl script.
#    * The helper routines are defined in ddr2_v12_1_p0_pin_map.tcl
#
# NOTE
# ----
...
source "$script_dir/ddr2_v12_1_p0_parameters.tcl"
source "$script_dir/ddr2_v12_1_p0_timing.tcl"
source "$script_dir/ddr2_v12_1_p0_pin_map.tcl"
...
if { $::GLOBAL_ddr2_v12_1_p0_phy_use_micro_timing } {
	##################
	#                #
	# QUERIED TIMING #
	#                #
	...
	set io_standard "$::GLOBAL_ddr2_v12_1_p0_io_standard CLASS I"

	# This is the peak-to-peak jitter on the whole read capture path
	set DQSpathjitter [expr [get_io_standard_node_delay -dst DQDQS_JITTER -io_standard $io_standard -parameters [list IO $::GLOBAL_ddr2_v12_1_p0_io_interface_type] -in_fitter]/1000.0]
	set DQSpathjitter_setup_prop [expr [get_io_standard_node_delay -dst DQDQS_JITTER_DIVISION -io_standard $io_standard -parameters [list IO $::GLOBAL_ddr2_v12_1_p0_io_interface_type] -in_fitter]/100.0]

	set tJITper [expr [get_io_standard_node_delay -dst MEM_CK_PERIOD_JITTER -io_standard $io_standard  -parameters [list IO $::GLOBAL_ddr2_v12_1_p0_io_interface_type] -in_fitter -period $t(CK)]/2000.0]
	...
	set half_period [ ddr2_v12_1_p0_round_3dp [ expr $t(CK) / 2.0 ] ]

	# Half of reference clock
	set ref_half_period [ ddr2_v12_1_p0_round_3dp [ expr $t(refCK) / 2.0 ] ]
	...
	set data_output_min_delay [ ddr2_v12_1_p0_round_3dp [ expr - $t(wru_output_min_delay_external) - $t(wru_output_min_delay_internal)]]
	...
	set data_output_max_delay [ ddr2_v12_1_p0_round_3dp [ expr $t(wru_output_max_delay_external) + $t(wru_output_max_delay_internal)]]
	...
	set data_input_max_delay [ ddr2_v12_1_p0_round_3dp [ expr $t(rdu_input_max_delay_external) + $t(rdu_input_max_delay_internal) ]]
	...
	set data_input_min_delay [ ddr2_v12_1_p0_round_3dp [ expr - $t(rdu_input_min_delay_external) - $t(rdu_input_min_delay_internal) ]]

	# Minimum delay on address and command paths
	set ac_min_delay [ ddr2_v12_1_p0_round_3dp [ expr - $t(IH) -$fpga(tPLL_JITTER) - $fpga(tPLL_PSERR) - $board(intra_addr_ctrl_skew) + $board(addresscmd_CK_skew) - $ISI(addresscmd_hold) ]]

	# Maximum delay on address and command paths
	set ac_max_delay [ ddr2_v12_1_p0_round_3dp [ expr $t(IS) +$fpga(tPLL_JITTER) + $fpga(tPLL_PSERR) + $board(intra_addr_ctrl_skew) + $board(addresscmd_CK_skew) + $ISI(addresscmd_setup) ]]
} else {
	##################
	#                #
	# DERIVED TIMING #
	...
	# Minimum delay on data output pins
	set data_output_min_delay [ ddr2_v12_1_p0_round_3dp [ expr - $t(DH) - $fpga(tPLL_JITTER) -$fpga(tPLL_PSERR) - $board(intra_DQS_group_skew) - $SSN(rel_pullin_o) ]]

	# Maximum delay on data output pins
	set data_output_max_delay [ ddr2_v12_1_p0_round_3dp [ expr $t(DS) + $fpga(tPLL_JITTER) + $fpga(tPLL_PSERR) + $board(intra_DQS_group_skew) + $SSN(rel_pushout_o) ]]

	# Maximum delay on data input pins
	set data_input_max_delay [ ddr2_v12_1_p0_round_3dp [ expr $t(DQSQ) + $board(intra_DQS_group_skew) + $SSN(rel_pushout_i) ]]

	# Minimum delay on data input pins
	set data_input_min_delay [ ddr2_v12_1_p0_round_3dp [ expr -$t(DCD) - $board(intra_DQS_group_skew) - $SSN(rel_pullin_i) ]]

	# Minimum delay on address and command paths
	set ac_min_delay [ ddr2_v12_1_p0_round_3dp [ expr - $t(IH) -$fpga(tPLL_JITTER) - $fpga(tPLL_PSERR) - $board(intra_addr_ctrl_skew) + $board(addresscmd_CK_skew) ]]

	# Maximum delay on address and command paths
	set ac_max_delay [ ddr2_v12_1_p0_round_3dp [ expr $t(IS) +$fpga(tPLL_JITTER) + $fpga(tPLL_PSERR) + $board(intra_addr_ctrl_skew) + $board(addresscmd_CK_skew)]]
}
...
if { ! [ info exists ddr2_v12_1_p0_sdc_cache ] } {
	set ddr2_v12_1_p0_sdc_cache 1
	ddr2_v12_1_p0_initialize_ddr_db ddr2_v12_1_p0_ddr_db
} else {
	if { $debug } {
...
# following loop
set instances [ array names ddr2_v12_1_p0_ddr_db ]
foreach { inst } $instances {
	if { [ info exists pins ] } {
		# Clean-up stale content
		unset pins
	}
	array set pins $ddr2_v12_1_p0_ddr_db($inst)
	...
	set fpga(tDQS_PHASE_JITTER) [ expr [ get_integer_node_delay -integer $::GLOBAL_ddr2_v12_1_p0_dqs_delay_chain_length -parameters {IO MAX HIGH} -src DQS_PHASE_JITTER -in_fitter ] / 1000.0 ]
	...
	if { $::GLOBAL_ddr2_v12_1_p0_phy_use_micro_timing } {
		...
		set final_data_input_max_delay [ ddr2_v12_1_p0_round_3dp [ expr $data_input_max_delay + $fpga(tDQS_PSERR) ]]
		set final_data_input_min_delay [ ddr2_v12_1_p0_round_3dp [ expr $data_input_min_delay - $t(CK) / 2.0 + $t(QH_time) - $fpga(tDQS_PSERR) - $tJITper]]
	...
	if { $debug } {
		...
		post_message -type info "SDC: -----------------"
		post_message -type info "SDC:    DQS Phase: $::GLOBAL_ddr2_v12_1_p0_dqs_delay_chain_length"
	...
	# PLL Clock Names
	set local_pll_afi_clk [ddr2_v12_1_p0_get_clock_name_from_pin_name_pre_vseries $pll_afi_clock "afi_clk"]
	set local_pll_mem_clk [ddr2_v12_1_p0_get_clock_name_from_pin_name_pre_vseries $pll_ck_clock "mem_clk"]
	set local_pll_addr_cmd_clk [ddr2_v12_1_p0_get_clock_name_from_pin_name_pre_vseries $pll_ac_clock "addr_cmd_clk"]
	set local_pll_write_clk [ddr2_v12_1_p0_get_clock_name_from_pin_name_pre_vseries $pll_write_clock "write_clk"]
	set local_pll_avl_clock [ddr2_v12_1_p0_get_clock_name_from_pin_name_pre_vseries $pll_avl_clock "avl_clk"]
	set local_pll_config_clock [ddr2_v12_1_p0_get_clock_name_from_pin_name_pre_vseries $pll_config_clock "config_clk"]
	...
	# W A R N I N G !
	# The PLL parameters are statically defined in the ddr2_v12_1_p0_parameters.tcl
	...
	# apply those changes to the PLL parameters in the ddr2_v12_1_p0_parameters.tcl

	set pll_i 5
	create_generated_clock -add -name "$local_pll_afi_clk" -source $pll_ref_clock -multiply_by $::GLOBAL_ddr2_v12_1_p0_pll_mult(0) -divide_by $::GLOBAL_ddr2_v12_1_p0_pll_div(0) -phase $::GLOBAL_ddr2_v12_1_p0_pll_phase(0) $pll_afi_clock
	if {[string compare -nocase $pll_afi_clock $pll_ck_clock]==0} {
		set local_pll_mem_clk $local_pll_afi_clk
	} else {
		create_generated_clock -add -name "$local_pll_mem_clk" -source $pll_ref_clock -multiply_by $::GLOBAL_ddr2_v12_1_p0_pll_mult(1) -divide_by $::GLOBAL_ddr2_v12_1_p0_pll_div(1) -phase $::GLOBAL_ddr2_v12_1_p0_pll_phase(1) $pll_ck_clock
	}
	create_generated_clock -add -name "$local_pll_addr_cmd_clk" -source $pll_ref_clock -multiply_by $::GLOBAL_ddr2_v12_1_p0_pll_mult(3) -divide_by $::GLOBAL_ddr2_v12_1_p0_pll_div(3) -phase $::GLOBAL_ddr2_v12_1_p0_pll_phase(3) $pll_ac_clock
	set write_clk_phase $::GLOBAL_ddr2_v12_1_p0_pll_phase(2)
	create_generated_clock -add -name "$local_pll_write_clk" -source $pll_ref_clock -multiply_by $::GLOBAL_ddr2_v12_1_p0_pll_mult(2) -divide_by $::GLOBAL_ddr2_v12_1_p0_pll_div(2) -phase $write_clk_phase $pll_write_clock
	set avl_pll_clk_i $pll_i
	if {[string compare -nocase $pll_afi_clock $pll_avl_clock]==0} {
		set local_pll_avl_clock $local_pll_afi_clk
	} else {
		create_generated_clock -add -name "$local_pll_avl_clock" -source $pll_ref_clock -multiply_by $::GLOBAL_ddr2_v12_1_p0_pll_mult($pll_i) -divide_by $::GLOBAL_ddr2_v12_1_p0_pll_div($pll_i) -phase $::GLOBAL_ddr2_v12_1_p0_pll_phase($pll_i) $pll_avl_clock
	}
	incr pll_i
	create_generated_clock -add -name "$local_pll_config_clock" -source $pll_ref_clock -multiply_by $::GLOBAL_ddr2_v12_1_p0_pll_mult($pll_i) -divide_by $::GLOBAL_ddr2_v12_1_p0_pll_div($pll_i) -phase $::GLOBAL_ddr2_v12_1_p0_pll_phase($pll_i) $pll_config_clock
	incr pll_i
	...
	create_generated_clock -add -name "${inst}|ddr2_v12_1_p0_leveling_clk" -master_clock [get_clocks $local_pll_write_clk] -source $pll_write_clock -phase $::GLOBAL_ddr2_v12_1_p0_leveling_capture_phase [ get_pins $leveling_pins ]
	...
	foreach dqs_out_clock_struct $dqs_out_clocks {
		...
		create_generated_clock -multiply_by 1 -master_clock [get_clocks "${inst}|ddr2_v12_1_p0_leveling_clk"] -source $dqs_out_clock(src) -phase 90 $dqs_out_clock(dst) -name $dqs_out_clock(dst)_OUT -add

		if { $::GLOBAL_ddr2_v12_1_p0_phy_use_micro_timing } {
			# Clock Uncertainty is accounted for by the ...pathjitter parameters
			set_clock_uncertainty -from [get_clocks ${inst}|ddr2_v12_1_p0_leveling_clk] -to [ get_clocks $dqs_out_clock(dst)_OUT ] 0
		}
	}
	...
	foreach dqsn_out_clock_struct $dqsn_out_clocks {
		...
		# Set DQS#phase to the ideal 90 degrees and let the calibration scripts take care of
		# properly adjust the margins
		create_generated_clock -multiply_by 1 -master_clock [get_clocks "${inst}|ddr2_v12_1_p0_leveling_clk"] -source $dqsn_out_clock(src) -phase 90 $dqsn_out_clock(dst) -name $dqsn_out_clock(dst)_OUT -add

		if { $::GLOBAL_ddr2_v12_1_p0_phy_use_micro_timing } {
			# Clock Uncertainty is accounted for by the ...pathjitter parameters
			set_clock_uncertainty -from [get_clocks ${inst}|ddr2_v12_1_p0_leveling_clk] -to [ get_clocks $dqsn_out_clock(dst)_OUT ] 0
		}
	}
	...
	if {(($::quartus(nameofexecutable) eq "quartus_fit"))} {
		set_max_delay -from $pins(fifo_rdaddress_reg) -to $pins(fifo_rddata_reg) [ddr2_v12_1_p0_round_3dp [expr $t(CK)/2.0]]
	...
	if {(270 - $::GLOBAL_ddr2_v12_1_p0_pll_phase(3)) > 90 || ($::GLOBAL_ddr2_v12_1_p0_pll_phase(3) - 270) > 90} {
		foreach { ck_pin } $ck_pins {
	...
	set_min_delay -from [get_registers $capture_reg] -to $fifo_wrdata_reg [ ddr2_v12_1_p0_round_3dp [expr -$t(CK) + 0.20 ]]

}

if { $::GLOBAL_ddr2_v12_1_p0_phy_use_micro_timing } {
	if {(($::quartus(nameofexecutable) ne "quartus_fit") && ($::quartus(nameofexecutable) ne "quartus_map"))} {
		set dqs_clocks [ddr2_v12_1_p0_get_all_instances_dqs_pins ddr2_v12_1_p0_ddr_db]
...
add_ddr_report_command "source [list [file join [file dirname [info script]] ${::GLOBAL_ddr2_v12_1_p0_corename}_report_timing.tcl]]"
