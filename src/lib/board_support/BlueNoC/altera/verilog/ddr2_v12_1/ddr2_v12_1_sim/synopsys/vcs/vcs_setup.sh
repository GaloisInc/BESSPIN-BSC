...
# ACDS 12.1 177 linux 2013.04.19.15:19:10
...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $USER_DEFINED_ELAB_OPTIONS \
  ...
  -v /raid/tools/altera/12.1/quartus/eda/sim_lib/stratixiii_atoms.v \
  ...
  $QSYS_SIMDIR/ddr2_v12_1/altera_mem_if_dll_stratixiii.sv \
  $QSYS_SIMDIR/ddr2_v12_1/altera_mem_if_oct_stratixiii.sv \
  ...
  $QSYS_SIMDIR/ddr2_v12_1/altdq_dqs2_ddio_3reg_stratixiii.sv \
