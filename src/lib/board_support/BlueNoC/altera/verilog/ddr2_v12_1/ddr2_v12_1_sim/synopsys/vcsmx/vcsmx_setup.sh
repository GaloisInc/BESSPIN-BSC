...
# ACDS 12.1 177 linux 2013.04.19.15:19:11
...
if [ $SKIP_DEV_COM -eq 0 ]; then
  ...
  vlogan +v2k           "/raid/tools/altera/12.1/quartus/eda/sim_lib/stratixiii_atoms.v"  -work stratixiii_ver  
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vlogan +v2k -sverilog                                  "$QSYS_SIMDIR/ddr2_v12_1/altera_mem_if_dll_stratixiii.sv"                                       -work dll0                                                     
  vlogan +v2k -sverilog                                  "$QSYS_SIMDIR/ddr2_v12_1/altera_mem_if_oct_stratixiii.sv"                                       -work oct0                                                     
  ...
  vlogan +v2k -sverilog                                  "$QSYS_SIMDIR/ddr2_v12_1/altdq_dqs2_ddio_3reg_stratixiii.sv"                                    -work p0                                                       
