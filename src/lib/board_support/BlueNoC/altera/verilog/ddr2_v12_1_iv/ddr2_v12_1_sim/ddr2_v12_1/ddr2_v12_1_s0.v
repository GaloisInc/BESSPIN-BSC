...
// 
// Generated using ACDS version 12.1 177 at 2013.04.19.15:11:17

`timescale 1 ps / 1 ps
module ddr2_v12_1_s0 (
	...
	altera_mem_if_sequencer_cpu_no_ifdef_params_sim_cpu_inst cpu_inst (
		.clk           (avl_clk),                                 //                       clk.clk
	...
	rw_manager_ddr2 #(
		...
		.HCX_COMPAT_MODE                      (0),
		.DEVICE_FAMILY                        ("STRATIXIV"),
		.AC_ROM_INIT_FILE_NAME                ("ddr2_v12_1_s0_AC_ROM.hex"),
		.INST_ROM_INIT_FILE_NAME              ("ddr2_v12_1_s0_inst_ROM.hex"),
	...
	altera_mem_if_sequencer_mem_no_ifdef_params #(
		...
		.AVL_SYMBOL_WIDTH (8),
		.MEM_SIZE         (11264),
		.INIT_FILE        ("ddr2_v12_1_s0_sequencer_mem.hex"),
		.RAM_BLOCK_TYPE   ("AUTO")
	) sequencer_mem (
	...
	ddr2_v12_1_s0_addr_router addr_router (
	...
	ddr2_v12_1_s0_addr_router_001 addr_router_001 (
	...
	ddr2_v12_1_s0_id_router id_router (
	...
	ddr2_v12_1_s0_id_router id_router_001 (
	...
	ddr2_v12_1_s0_id_router id_router_002 (
	...
	ddr2_v12_1_s0_id_router_003 id_router_003 (
	...
	ddr2_v12_1_s0_id_router id_router_004 (
	...
	ddr2_v12_1_s0_id_router id_router_005 (
	...
	ddr2_v12_1_s0_cmd_xbar_demux cmd_xbar_demux (
		.clk                (avl_clk),                           //       clk.clk
		.reset              (rst_controller_reset_out_reset),    // clk_reset.reset
	...
	ddr2_v12_1_s0_cmd_xbar_demux_001 cmd_xbar_demux_001 (
		.clk                (avl_clk),                               //       clk.clk
		.reset              (rst_controller_reset_out_reset),        // clk_reset.reset
	...
	ddr2_v12_1_s0_cmd_xbar_mux_003 cmd_xbar_mux_003 (
		.clk                 (avl_clk),                               //       clk.clk
		.reset               (rst_controller_reset_out_reset),        // clk_reset.reset
	...
	ddr2_v12_1_s0_cmd_xbar_demux_001 rsp_xbar_demux (
		.clk                (avl_clk),                           //       clk.clk
		.reset              (rst_controller_reset_out_reset),    // clk_reset.reset
	...
	ddr2_v12_1_s0_cmd_xbar_demux_001 rsp_xbar_demux_001 (
		.clk                (avl_clk),                               //       clk.clk
		.reset              (rst_controller_reset_out_reset),        // clk_reset.reset
	...
	ddr2_v12_1_s0_cmd_xbar_demux_001 rsp_xbar_demux_002 (
		.clk                (avl_clk),                               //       clk.clk
		.reset              (rst_controller_reset_out_reset),        // clk_reset.reset
	...
	ddr2_v12_1_s0_rsp_xbar_demux_003 rsp_xbar_demux_003 (
		.clk                (avl_clk),                               //       clk.clk
		.reset              (rst_controller_reset_out_reset),        // clk_reset.reset
	...
	ddr2_v12_1_s0_cmd_xbar_demux_001 rsp_xbar_demux_004 (
		.clk                (avl_clk),                               //       clk.clk
		.reset              (rst_controller_reset_out_reset),        // clk_reset.reset
	...
	ddr2_v12_1_s0_cmd_xbar_demux_001 rsp_xbar_demux_005 (
		.clk                (avl_clk),                               //       clk.clk
		.reset              (rst_controller_reset_out_reset),        // clk_reset.reset
	...
	ddr2_v12_1_s0_rsp_xbar_mux rsp_xbar_mux (
		.clk                 (avl_clk),                               //       clk.clk
		.reset               (rst_controller_reset_out_reset),        // clk_reset.reset
	...
	ddr2_v12_1_s0_irq_mapper irq_mapper (
		.clk        (avl_clk),                        //       clk.clk
		.reset      (rst_controller_reset_out_reset), // clk_reset.reset
