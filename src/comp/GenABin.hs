...
import Flags(Flags(..), DumpFlag(..), ResourceFlag(..), SATFlag(..),
             LicenseType(..), MsgListFlag(..), Verbosity(..))
...
instance Bin Flags where
    writeBytes (Flags
		...
		a_110 a_111 a_112 a_113 a_114 a_115 a_116 a_117 a_118 a_119
                ...
                a_140 a_141 a_142 a_143 a_144 a_145 a_146 a_147) =
	  ...
	  toBin a_120; toBin a_121; toBin a_122; toBin a_123; toBin a_124;
          ...
          toBin a_140; toBin a_141; toBin a_142; toBin a_143; toBin a_144;
          toBin a_145; toBin a_146; toBin a_147
    ...
    readBytes =
	  ...
	  a_120 <- fromBin; a_121 <- fromBin; a_122 <- fromBin; a_123 <- fromBin; a_124 <- fromBin;
          ...
          a_140 <- fromBin; a_141 <- fromBin; a_142 <- fromBin; a_143 <- fromBin; a_144 <- fromBin;
          a_145 <- fromBin; a_146 <- fromBin; a_147 <- fromBin
          return (Flags
		a_000 a_001 a_002 a_003 a_004 a_005 a_006 a_007 a_008 a_009
		a_010 a_011 a_012 a_013 a_014 a_015 a_016 a_017 a_018 a_019
		a_020 a_021 a_022 a_023 a_024 a_025 a_026 a_027 a_028 a_029
...
instance Bin LicenseType where
    writeBytes Any      = putI 0
    writeBytes Floating = putI 1
    writeBytes Seat     = putI 2
    writeBytes BlueSimOnly  = putI 3
    --
    readBytes = do
      i <- getI
      case i of
        ...
        1 -> return Floating
        2 -> return Seat
        3 -> return BlueSimOnly
        n -> internalError $ "GenABin(LicenseType).readBytes: " ++ show n
